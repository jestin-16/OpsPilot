...
export const LiveProjectDashboard: React.FC = () => {
  ...
  const initialLayout = [
    ...
    { i: 'github-commits', x: 0, y: 23, w: 12, h: 8 },
  ];
        ...
        <div className="max-w-[1600px] mx-auto space-y-4">
          ...
          <div className="w-full relative">
             ...
             >
                ...
                <div key="github-commits" className={`bg-[#141414] rounded-xl border border-[#2a2a2a] shadow-lg flex flex-col h-full relative ${isEditMode ? 'cursor-move ring-1 ring-emerald-500/50' : ''}`}>
                  <div className="px-4 py-3 flex justify-between items-center border-b border-[#2a2a2a] bg-[#1c1c1c] rounded-t-xl">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 overflow-y-auto p-4 bg-[#141414] rounded-b-xl scrollbar-thin scrollbar-thumb-[#2a2a2a] scrollbar-track-transparent">
                    {commits.length === 0 ? (
                        <div className="text-slate-600 font-mono text-[10px]">No commits found for this project.</div>
                    ) : (
